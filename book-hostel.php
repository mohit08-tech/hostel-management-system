...
<div class="form-group">
<label class="col-sm-2 control-label">Enter Total Amount</label>
<div class="col-sm-8">
<input type="number" name="ta" id="ta"  class="result form-control" >
</div>
</div>
...
<div class="col-sm-8">
<input type="number" name="regno" id="regno"  class="form-control" value="<?php echo $row->regNo;?>" readonly >
</div>
</div>
...
<div class="col-sm-8">
<input type="number" name="contact" id="contact" value="<?php echo $row->contactNo;?>" maxlength="10" class="form-control" readonly>
</div>
</div>
...
<div class="col-sm-8">
<input type="number" name="econtact" id="econtact" maxlength="10" class="form-control" required="required">
</div>
</div>
...
<div class="col-sm-8">
<input type="number" name="gcontact" id="gcontact" maxlength="10"  class="form-control" required="required">
</div>
</div>	
...
<div class="col-sm-8">
<input type="number" name="pincode" id="pincode" maxlength="6"  class="form-control" required="required">
</div>
</div>	
...
<label class="col-sm-2 control-label">Pincode : </label>
<div class="col-sm-8">
<input type="number" name="ppincode" id="ppincode" maxlength="6"  class="form-control" required="required">
</div>
</div>	
